...
const configData = [
    ...
    {
        name: 'effect',
        declare: 'Tooltip 主题，Element Plus 内置了 dark / light 两种主题',
        type: 'enum / string',
        default: "'light'",
        options: ['dark', 'light']
    },
    {
        name: 'content',
        declare: '显示的内容，也可以通过写入默认 slot 修改显示内容',
        type: 'string',
        default: "''"
    },
    {
    ...
    {
        name: 'disabled',
        declare: 'Popover 是否可用',
        type: 'boolean',
        default: 'false'
    },
    {
        name: 'visible / v-model:visible',
        declare: 'Popover 是否显示',
        type: 'boolean / null',
        default: 'null'
    },
    {
        name: 'offset',
        declare: '浮层偏移量, Popover 是在 Tooltip 基础上开发的，Popover的 offset 是 undefined, 但Tooltip 的 offset 是12',
        type: 'number',
        default: 'undefined'
    },
    {
        name: 'transition',
        declare: '定义渐变动画，默认是 el-fade-in-linear',
        type: 'string',
        default: '—'
    },
    {
        name: 'show-arrow',
        declare: '是否显示 Tooltip 箭头，欲了解更多信息，请参考 ElPopper',
        type: 'boolean',
        default: 'true'
    },
    {
        name: 'popper-options',
        declare: 'popper.js 的参数',
        type: 'object',
        default: "{modifiers: [{name: 'computeStyles',options: {gpuAcceleration: false}}]}"
    },
    {
        name: 'popper-class',
        declare: '为 popper 添加类名',
        type: 'string',
        default: "''"
    },
    {
        name: 'popper-style',
        declare: '为 popper 自定义样式',
        type: 'string / object',
        default: "''"
    },
    {
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "popover-base-box" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "row center" },
});
const __VLS_7 = {}.ElPopover;
...
/** @type {__VLS_StyleScopedClasses['popover-base-box']} */ ;
